...
public class CriptografiaRSA {
	...
	private static PublicKey getChaveSecreta(String chaveSecreta) throws Exception {
		PublicKey retorno = null;
		
		EncodedKeySpec especificacaoDaChaveSecreta= new X509EncodedKeySpec(Base64.getDecoder().decode(chaveSecreta));
		retorno = KeyFactory.getInstance("RSA").generatePublic(especificacaoDaChaveSecreta);
	...
	private static String encriptarAES(String texto, SecretKey chaveCompartilhadaAES) throws Exception {
		...
		IvParameterSpec objIv = new IvParameterSpec("012345Junior9876".getBytes()); // tem que ter 16 caracteres
