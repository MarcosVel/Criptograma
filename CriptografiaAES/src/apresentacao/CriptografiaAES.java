...
public class CriptografiaAES extends JFrame {
	...
	private static String encriptar(String texto, String senha) throws Exception {
		SecretKey objChaveSecreta = new SecretKeySpec(senha.getBytes(), "AES");
		IvParameterSpec objIv = new IvParameterSpec("JuniorEhBonitao!".getBytes());
